 ...
 *
 * @param data - Encoded image prefix or complete payload.
 * @returns Detected media type, or undefined for unsupported input.
 */
 ...
 *
 * @param ctx - Tool, filesystem, and model service context.
 * @param original - Harness read_image definition used for local paths.
 * @returns Enhanced tool definition accepting local paths and HTTP(S) URLs.
 */
 ...
 *
 * @param ctx - Agent and tool registry context.
 * @param policy - Live image-tool preference owner.
 */
