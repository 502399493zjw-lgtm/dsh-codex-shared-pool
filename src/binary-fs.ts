 ...
 *
 * @param ctx - Filesystem and sandbox service context.
 * @param exec - Active tool execution and cancellation signal.
 * @param target - Resolved workspace destination.
 * @param content - Complete byte payload to publish.
 * @param expected - Optional observed-version write intent.
 * @returns Published file operation, version, and byte count.
 */
