 ...
 *
 * @param ctx - Model catalog context.
 * @param exec - Active tool execution with the conversation route.
 * @param action - User-facing action named in an unavailable diagnostic.
 */
